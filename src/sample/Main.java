...
public class Main extends Application {
    ...
    @FXML
    private static final Image SpriteMovement = new Image("http://upload.wikimedia.org/wikipedia/commons/7/73/The_Horse_in_Motion.jpg");
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        Play.setOnMouseClicked(e -> {
            final ImageView imageView = new ImageView(SpriteMovement);
